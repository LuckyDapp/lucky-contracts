    ...
    mod tests {
        ...
        fn test_run_raffle_no_ratio_set() {
            ...
            let participants = vec![
                (accounts.alice, 100000),
                (accounts.bob, 100000),
                (accounts.charlie, 100000),
                (accounts.django, 100000),
                (accounts.eve, 100000),
                (accounts.frank, 100000),
            ];
            contract
                .add_participants_with_filters(participants)
                .unwrap();
        ...
        fn test_run_raffle_no_participant() {
            ...
            contract
                .set_ratio_distribution(vec![50, 30, 20], 100)
                .unwrap();
        ...
        fn test_run_raffle_with_zero_in_ratio() {
            ...
            contract
                .set_ratio_distribution(vec![50, 0, 50], 100)
                .unwrap();
        ...
        fn test_run_raffle_not_already_done() {
            ...
            match result {
                Err(RaffleError::RaffleAlreadyDone) => {
                    debug_println!("RaffleAlreadyDone as expected")
                }
                _ => panic!("Error 1"),
            };
        ...
        fn test_run_raffle_share_partial_rewards() {
            ...
            contract
                .set_ratio_distribution(vec![50, 30, 20], 200)
                .unwrap();
        ...
        fn test_raffle_contract() {
            ...
            contract
                .add_participants_with_filters(vec![
                    (accounts.alice, 100000),
                    (accounts.bob, 100000),
                    (accounts.charlie, 100000),
                    (accounts.django, 100000),
        ...
        fn test_add_participants_with_filters() {
            ...
            contract
                .add_participants_with_filters(vec![(accounts.alice, 100000)])
                .unwrap();
            ...
            contract
                .add_participants_with_filters(vec![(accounts.alice, 100000), (accounts.bob, 1)])
                .unwrap();
